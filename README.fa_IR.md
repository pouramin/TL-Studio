...
- **Live Preview** — Preview لوکال برای HTML یا Node dev server در پنجره‌ی قابل‌جابجایی و تغییر اندازه؛ فایل HTML فعال در Editor اولویت دارد، `index.html` وقتی فایل مشخصی انتخاب نشده باشد Default است، بین چند HTML می‌توان در حالت Live سوییچ کرد و لبه‌ی چپ پنجره برای تغییر عرض قابل Drag است.
